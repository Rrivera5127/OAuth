...
define(
    ...
    function (lang, dojoJson, Url, html, sniff, on, cookie, Deferred, ioquery, idManager) {

        var OAuthHelper = {

            portal: "http://www.arcgis.com",

            popupCallbackPage: window.location.protocol + "//" + window.location.host + "/oauth-callback.html",
